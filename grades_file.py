...
#   Postion 0 is last name l is fist name and 2 is homework, 4 is midterm exam 4 is final exam 
...
def calculate_grades():
    ...
    for i in range(len(stu)):
        hw = int(stu[i][2]) #Last name is pos. O, first name is pos. 1, homework is pos. 2
